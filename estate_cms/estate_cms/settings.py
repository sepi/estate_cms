"""
Django settings for estate_cms project.
...
SECRET_KEY = 'django-insecure-l%15-bt)eny=mnbja*+985%*$=i@(317r2mg&!d^-@1s!w-0(v'
...
ROOT_URLCONF = 'estate_cms.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "estate_cms", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
